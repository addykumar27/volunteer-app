...
organization_4 = Organization.create({name:"Simply the Basics", catgeory: "Homeless & Housing", location:"520 PARKER AVE
Unit 101
...
opportunity_1.organization = organization_1
opportunity_2.users.push(user_3)
user_1. opportunities.push(opportunity_1)
user_2.opportunities.push(opportunity_1)
